  ...
  module WikiControllerRwp
    def self.prepended(base)
      base.class_eval do
        ...
        before_action :rwp_find_page_for_actions, only: %i[rename destroy history annotate destroy_version add_attachment diff]
        before_action :rwp_check_wiki_permissions, only: %i[show edit update rename destroy history annotate destroy_version add_attachment diff]
    ...
    def rwp_check_wiki_permissions
      ...
      case action_name
      when 'show', 'history', 'annotate', 'diff'
